...
Tracking lifecycle requires that the Adobe Cloud Platform SDKs have a valid configuration. For more information, see [Configuration Methods in Android](../../../client-side-information/mobile/sdk-core/configuration-methods-in-android.md).
